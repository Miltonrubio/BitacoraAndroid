...
public class DesgloseConsumos extends RecyclerView.Adapter<DesgloseConsumos.ViewHolder> {
            ...
            holder.itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    fragmentManager.beginTransaction()
                            ...
                            .addToBackStack(null)
                            .commit();
                    dialogConsultarDesgloses.dismiss();
                }
    ...
    AlertDialog dialogConsultarDesgloses;

    public DesgloseConsumos(List<JSONObject> data, Context context, AlertDialog dialogConsultarDesgloses) {

        this.data = data;
        this.context = context;
        this.filteredData = new ArrayList<>(data);
        url = context.getResources().getString(R.string.urlApi);
        this.dialogConsultarDesgloses = dialogConsultarDesgloses;
    }
